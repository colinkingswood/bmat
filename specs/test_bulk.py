...
song4 = (u"Performer1", u"Song1", 600)
song5 = (u"Performer4", u"Song2", 180)
song6 = (u"Pêrformer4", u"Song3", 180)
song7 = (u"Performer4", u"Song4", 600)
song8 = (u"Performer4", u"Song5", 180)
song9 = (u"Performer4", u"Song6", 180)
song10 = (u"Performer4", u"Song7", 600)
song11 = (u"Performer4", u"Song8", 180)
song12 = (u"Performer4", u"Song9", 180)
...
plays = {
    ...
    'Channel2': {
        ...
        (2014, 1, 9,  1, 0, 0) : song4,
        (2014, 1, 10, 2, 0, 0) : song5,
        (2014, 1, 11, 3, 0, 0) : song6,
        (2014, 1, 8,  4, 0, 0) : song7,
        (2014, 1, 9,  5, 0, 0) : song8,
        (2014, 1, 10, 5, 30, 0): song9,
        (2014, 1, 11, 6, 0, 0) : song10,
        (2014, 1, 8,  7, 0, 0) : song11,
        (2014, 1, 9,  8, 0, 0) : song12,

        (2014, 1, 2,  1, 0, 0): song4,
        (2014, 1, 1, 2, 0, 0) : song5,
        (2014, 1, 3, 3, 0, 0) : song6,
        (2014, 1, 4,  4, 0, 0): song7,
        (2014, 1, 4,  5, 0, 0): song8,
        (2014, 1, 2, 5, 30, 0): song9,
        (2014, 1, 1, 6, 0, 0) : song10,
        (2014, 1, 3,  7, 0, 0): song11,
        (2014, 1, 3,  8, 0, 0): song12,
    }
}
...
def check_top():
    ...
    print "result :", res
    print "    top:" , top
    print "get top:" , get_top(datetime.datetime(2014, 1, 8), plays.keys())
